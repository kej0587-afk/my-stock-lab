...
def test_today_queue_execution_snapshot_uses_nearest_support_for_wait_signal(helpers):
    snap = helpers.build_today_queue_execution_snapshot(
        "Apple",
        "AAPL",
        {
            "cur_p": 100.0,
...
def test_today_queue_execution_snapshot_hides_entry_price_for_weight_block(helpers):
    snap = helpers.build_today_queue_execution_snapshot(
        "Freeport McMoRan",
        "FCX",
        {
