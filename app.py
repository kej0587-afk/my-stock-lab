...
SECTOR_BENCHMARK_MAP = {
    ...
    "SMCI": ("SMH", "미국 반도체"),
    # ── 관심종목 추가분 ──────────────────────────────────────────────
    "012330": ("091180.KS", "자동차"),       # 현대모비스 (TIGER 200 자동차)
    "307950": ("139260.KS", "IT/기술"),      # 현대오토에버 (TIGER 200 IT)
    "083450": ("487240.KS", "전력인프라"),   # GST (KODEX AI전력핵심설비)
    "062040": ("487240.KS", "전력인프라"),   # 산일전기 (KODEX AI전력핵심설비)
    "007660": ("396500.KS", "반도체"),       # 이수페타시스 (TIGER 반도체TOP10)
    "ALAB":   ("SMH", "미국 반도체"),        # 아스테라랩스
    "IONQ":   ("XLK", "미국 기술"),          # 아이온큐
}
