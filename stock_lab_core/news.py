...
SEVERE_NEGATIVE_NEWS_SIGNALS = [
    ...
    ("excess ai compute", "AI 인프라 잉여 컴퓨팅 판매 가능성은 반도체 수요 기대에 부담"),
    ("excess compute", "잉여 컴퓨팅 판매 가능성은 AI 인프라 수요 기대에 부담"),
    ("surplus compute", "잉여 컴퓨팅 판매 가능성은 AI 인프라 수요 기대에 부담"),
    ("surplus computing", "잉여 컴퓨팅 판매 가능성은 AI 인프라 수요 기대에 부담"),
    ("offload surplus", "잉여 인프라 매각/임대 가능성은 수요 과잉 우려"),
    ("selling excess", "잉여 인프라 판매 가능성은 수요 과잉 우려"),
    ("sell excess", "잉여 인프라 판매 가능성은 수요 과잉 우려"),
    ("overcapacity", "공급 과잉 우려는 밸류에이션 부담"),
    ("oversupply", "공급 과잉 우려는 밸류에이션 부담"),
    ("blacklisted cxmt", "중국 메모리 공급망/제재 리스크는 메모리주에 부담"),
    ("chinese memory chips", "중국 메모리 대체 가능성은 기존 메모리 공급자에 부담"),
    ("chinese memory", "중국 메모리 대체 가능성은 기존 메모리 공급자에 부담"),
...
NEGATIVE_NEWS_SIGNALS = [
    *SEVERE_NEGATIVE_NEWS_SIGNALS,
    ...
    ("꺾이나", "상승 흐름이 꺾일 수 있다는 경고"),
    ("공포", "공포 확산은 위험자산 투자심리에 부담"),
    ("인상 전환", "금리 인상 전환은 성장주와 레버리지에 부담"),
    ("인상 가능", "금리 인상 가능성은 밸류에이션 부담"),
    ("매파", "매파적 통화정책 해석은 위험자산에 부담"),
    ("긴축", "긴축 기조는 유동성 환경에 부담"),
    ("외국인 이탈", "외국인 수급 이탈은 단기 수급 부담"),
    ("랠리 둔화", "랠리 둔화는 수급 약화 단서"),
    ("rate hike", "금리 인상 가능성은 성장주와 레버리지에 부담"),
    ("possible hike", "금리 인상 가능성은 성장주와 레버리지에 부담"),
    ("projects hike", "점도표상 인상 전망은 통화정책 부담"),
    ("tightening fear", "긴축 공포는 위험자산 투자심리에 악재"),
    ("hawkish", "매파적 통화정책 해석은 위험자산에 부담"),
...
NEWS_THEME_TERMS_BY_SYMBOL = {
    ...
    "MAGS": ["Magnificent Seven", "Mag 7", "Microsoft", "Meta", "Nvidia", "Tesla", "Alphabet", "Amazon"],
    ...
    "0227L0": ["에이전틱AI", "Agentic AI", "Microsoft", "Amazon", "Google", "Meta", "Dell"],
