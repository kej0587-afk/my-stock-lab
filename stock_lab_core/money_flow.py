...
MONEY_FLOW_UNIVERSE = [
    ...
    {"구분": "미국 섹터", "섹터": "메모리/DRAM",     "ticker": "DRAM", "name": "Roundhill Memory ETF"},
    {"구분": "미국 섹터", "섹터": "DRAM 2배",        "ticker": "RAM",  "name": "Roundhill T-REX 2X Long DRAM Daily Target ETF"},
    {"구분": "미국 섹터", "섹터": "Magnificent 7",   "ticker": "MAGS", "name": "Roundhill Magnificent Seven ETF"},
    ...
    {"구분": "한국 섹터", "섹터": "미국 에이전틱AI", "ticker": "0227L0.KS", "name": "HANARO 미국에이전틱AI TOP2+"},
