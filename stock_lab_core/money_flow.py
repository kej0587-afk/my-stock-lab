...
# ---------------------------------------------------------------------------
# 섹터 클러스터 — 로테이션 맵 그룹핑 (30+ ETF → 6개 클러스터로 압축)
# ---------------------------------------------------------------------------

SECTOR_CLUSTERS: dict[str, list[str]] = {
    "AI·기술":      ["QQQ", "069500.KS", "229200.KS", "396500.KS", "139260.KS",
                     "XLK", "XLC", "SOXX", "SMH", "IGV", "CIBR", "FINX", "BOTZ", "QTUM"],
    "에너지·인프라": ["XLE", "PAVE", "GRID", "ICLN", "UFO",
                     "487240.KS", "0117V0.KS", "487230.KS", "491010.KS"],
    "우주·방산":     ["SHLD", "ITA", "UFO"],
    "원전·우라늄":   ["434730.KS", "URA"],
    "헬스케어·소비": ["XLV", "XLP", "IBB", "244580.KS", "XLY", "XLF", "XLC",
                     "479850.KS"],
    "경기·산업":     ["XLI", "XLB", "VNQ", "XHB", "COPX", "LIT",
                     "305540.KS", "139220.KS", "329200.KS", "494670.KS",
                     "FLIN", "EWZ"],
}
