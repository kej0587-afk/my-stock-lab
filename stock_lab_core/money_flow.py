...
MONEY_FLOW_UNIVERSE = [
    ...
    {"구분": "한국 섹터", "섹터": "전력기기", "ticker": "487290.KS", "name": "TIGER 코리아AI전력기기TOP3플러스"},
    ...
    {"구분": "한국 섹터", "섹터": "부동산/리츠", "ticker": "432730.KS", "name": "KODEX K-리얼티"},
    ...
    {"구분": "월배당 ETF", "섹터": "금 커버드콜", "ticker": "494480.KS", "name": "SOL 국제금커버드콜액티브"},
