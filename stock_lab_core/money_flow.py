...
IMAGE_THEME_GROUPS = [
    ...
    },
    {
        ...
        "groups": [
            ...
            ("SMR 개발사", [("뉴스케일파워", "SMR"), ("오클로", "OKLO"), ("롤스로이스홀딩스", "RR.L")]),
            ("원전 공급망", [("BWX테크놀로지스", "BWXT"), ("카메코", "CCJ"), ("두산에너빌리티", "034020.KS")]),
            ("우라늄/연료", [("카메코", "CCJ"), ("센트러스에너지", "LEU")]),
            ("전력 장비", [("이튼", "ETN"), ("GE버노바", "GEV"), ("HD현대일렉트릭", "267260.KS")]),
            ("냉각/인프라", [("버티브", "VRT"), ("SNT에너지", "100840.KS")]),
            ("산업 자동화", [("에머슨일렉트릭", "EMR"), ("허니웰", "HON"), ("록웰오토메이션", "ROK")]),
        ],
    },
    {
        "theme": "빅테크·AI 인프라",
